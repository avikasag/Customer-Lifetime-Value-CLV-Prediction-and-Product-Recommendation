...
* Calculated the Monetary, Frequency, and Recency (RFM) metrics for each customer.
...
* **Predicted CLV:** Calculated for each unique customer.
* **Customer Segments:** Groups defined by purchasing behavior.
* **Recommendations:** Top product suggestions for a selected customer.
